...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ['chantily', 'dinheiro', 'Item extra não pode ser pedido sem o principal', ['chantily,1']],
        ['queijo', 'credito', 'Item extra não pode ser pedido sem o principal', ['queijo,1']],
        ['com código inexistente', 'debito', 'Item inválido!', ['cafe,1', 'brigadeiro,2']],
        ['com quantidade zero', 'credito', 'Quantidade inválida!', ['cafe,0', 'sanduiche,0']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));

    test.each([
        ['debito', 'R$ 17,20', ['cafe,1', 'chantily,1', 'sanduiche,1', 'suco,1']],
        ['credito', 'R$ 27,71', ['suco,2', 'salgado,2']],
        ['dinheiro', 'R$ 16,15', ['combo1,1', 'combo2,1']],
    ])('compra de múltiplas quantidades em %p deve resultar em %p', validaTeste);

    test.each([
        ['compra de combo1 com queijo extra', 'debito', 'Item extra não pode ser pedido sem o principal', ['combo1,1', 'queijo,1']],
        ['compra de combo2 com chantily extra', 'credito', 'Item extra não pode ser pedido sem o principal', ['combo2,1', 'chantily,1']],
        ['combinação de desconto e acréscimo em dinheiro', 'dinheiro', 'R$ 10,93', ['cafe,1', 'sanduiche,1', 'queijo,1']],
        ['combinação de desconto e acréscimo a crédito', 'credito', 'R$ 11,85', ['cafe,1', 'sanduiche,1', 'queijo,1']],
        ['compras com diferentes formas de pagamento', 'debito', 'R$ 11,50', ['cafe,1', 'sanduiche,1', 'queijo,1']],
        ['compra de grandes quantidades', 'credito', 'R$ 211,15', ['cafe,20', 'chantily,10', 'sanduiche,20']],
        ['compras inválidas - item não existe', 'debito', 'Item inválido!', ['cafe,1', 'brigadeiro,2']],
        ['compras inválidas - forma de pagamento inválida', 'especie', 'Forma de pagamento inválida!', ['cafe,1']],
    ])('Teste adicional: %s em %s deve resultar em %s', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
